...
`;
    ...
    expect(ast.result.props[0].dataType).toBe(typeKeywords[types.Float]);
    expect(ast.result.props[0].value).toBe('year');
    expect(ast.result.props[1].type).toBe('prop');
    expect(ast.result.props[1].dataType).toBe(typeKeywords[types.String]);
    expect(ast.result.props[1].value).toBe('make');
    expect(ast.result.props[2].type).toBe('prop');
    expect(ast.result.props[2].dataType).toBe(typeKeywords[types.String]);
