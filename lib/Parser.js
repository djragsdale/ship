...
// - Struct
const accessOp = char(operators.ACCESS).map(mapToOperator);
...
// let stringMethods;
// const charToString = recursiveParser(() => (sequenceOf([
//   choice([
//     characterValue,
//     variableName,
//     characterMethods, // Not defined yet
//   ]),
//   accessOp,
//   str('str'),
// ])
...
// // Should these be by source or by result?
// // Probably result. These are methods that produce strings
// stringMethods = recursiveParser(() => (choice([
//   charToString,
//   stringLen,

// ])));

// charMethods = recursiveParser(() => (choice([
//   stringChar, 
// ])));
